...
import vn.asiantech.newreviewproject.fragments.TabFourFragment_;

/**
 *  Created by sunday on 06/10/2015.
 */
public class TabFourContainer extends BaseContainerFragment{
    ...
    public void initViewFragment(){
        replaceFragment(new TabFourFragment_(), false);
    }
